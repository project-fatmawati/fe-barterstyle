      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 md:gap-5 place-items-center">
          {ProductsData.map((data) => (
            <div
              data-aos="zoom-in"
              className="rounded-2xl bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-primary hover:text-black relative shadow-xl duration-300 group max-w-[300px]"
            >
              {/* image section */}
              ...
              <div className="p-4 text-center">
                ...
                <h1 className="text-xl font-bold text-black group-hover:text-white">{data.title}</h1>
